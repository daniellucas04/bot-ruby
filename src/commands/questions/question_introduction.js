...
const introductionQuestion = require('../../events/table_introduction_questions.js')(sequelize);

module.exports = {
    data: new SlashCommandBuilder()
    .setName('perguntas-introducao')
    .setDescription('Finalizou o conteúdo de introdução? faça alguns exercícios para fixar!'),
    
    async execute(interaction){
        const data = await introductionQuestion.findAll({ attributes: ['id', 'Enunciado', 'AlternativeA', 'AlternativeB', 'AlternativeC', 'AlternativeD', 'AlternativeE', 'CorrectAlternative'], raw: true, order: [['id']] })
