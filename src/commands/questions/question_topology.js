...
const topologyQuestion = require('../../events/table_topology_questions.js')(sequelize);

module.exports = {
    data: new SlashCommandBuilder()
        .setName('perguntas-topologia')
        .setDescription('Finalizou o conteúdo de LAN? faça alguns exercícios para fixar!.'),

    async execute(interaction) {
        const data = await topologyQuestion.findAll({ attributes: ['id', 'Enunciado', 'AlternativeA', 'AlternativeB', 'AlternativeC', 'AlternativeD', 'AlternativeE', 'CorrectAlternative'], raw: true, order: [['id']] })
